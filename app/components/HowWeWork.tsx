      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-12">
          <div className="flex flex-col items-center">
            <FaWhatsapp size={60} className="text-black mb-4" />
            <h3 className="text-lg font-bold mb-2 text-center">1. Contacto rápido</h3>
          ...
          <div className="flex flex-col items-center">
            <FaClipboardCheck size={60} className="text-black mb-4" />
            <h3 className="text-lg font-bold mb-2 text-center">2. Visita y validación del presupuesto</h3>
          ...
          <div className="flex flex-col items-center">
            <FaLeaf size={60} className="text-black mb-4" />
            <h3 className="text-lg font-bold mb-2 text-center">3. Mantenimiento sin preocupaciones</h3>
