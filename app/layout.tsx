...
export const metadata: Metadata = {
  ...
  keywords: [
    "mantenimiento piscinas y jardines Salamanca",
    "piscinas Salamanca",
    "mantenimiento piscinas Salamanca",
    "limpieza piscinas Salamanca",
    "jardinería Salamanca",
    "jardinero Salamanca",
    "mantenimiento jardines Salamanca",
    "arreglos de jardín Salamanca",
    "empresa jardinería Salamanca",
    "corte de césped Salamanca",
    "poda de setos Salamanca",
    "desbroce Salamanca",
    "jardines",
    "piscinas",
    "césped",
  ...
  verification: {
    google: "gCJtMosktTrRizkyefwjjW7_jrprWtfMhg74QDCkJ1c",
  },
  icons: {
    icon: "/icons/logo.svg",
